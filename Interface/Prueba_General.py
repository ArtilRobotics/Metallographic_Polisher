...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.radio_button_1 = customtkinter.CTkRadioButton(self.tabview.tab("Selección Parámetros"), command=self.material1,variable=self.material_menu, value=0)
        self.radio_button_1.grid(row=1, column=0, pady=10, padx=20, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(self.tabview.tab("Selección Parámetros"), command=self.material2,variable=self.material_menu, value=1)
        self.radio_button_2.grid(row=2, column=0, pady=10, padx=20, sticky="n")
        self.radio_button_3 = customtkinter.CTkRadioButton(self.tabview.tab("Selección Parámetros"), command=self.material3,variable=self.material_menu, value=2)
        ...
        self.radio_button_1 = customtkinter.CTkRadioButton(self.tabview.tab("Selección Parámetros"), command=self.diametro1,variable=self.diametro_menu, value=0)
        self.radio_button_1.grid(row=1, column=1, pady=10, padx=20, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(self.tabview.tab("Selección Parámetros"), command=self.diametro2,variable=self.diametro_menu, value=1)
        self.radio_button_2.grid(row=2, column=1, pady=10, padx=20, sticky="n")
        self.radio_button_3 = customtkinter.CTkRadioButton(self.tabview.tab("Selección Parámetros"), command=self.diametro3,variable=self.diametro_menu, value=2)
        ...
        self.checkbox_1 = customtkinter.CTkCheckBox(master=self.tabview.tab("Selección Parámetros"),command=self.diametro3)
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.tabview.tab("Selección Parámetros"), command=self.boton1)
        self.sidebar_button_1.grid(row=5, column=2, padx=20, pady=10)

        self.sidebar_button_2 = customtkinter.CTkButton(self.tabview.tab("Selección Parámetros"), command=self.boton2)
